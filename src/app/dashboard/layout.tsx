...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  return (
    <div style={{ display: 'flex', minHeight: '100vh', width: '100vw', background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(20px)' }}>
      {/* Sidebar */}
      <aside className="glass-panel" style={{ width: '250px', borderRight: '1px solid var(--glass-border)', borderRadius: '0', borderRightWidth: '1px', padding: '2rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem', borderTop: 'none', borderLeft: 'none', borderBottom: 'none' }}>
